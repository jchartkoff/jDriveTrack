...
public interface SerialInterface {
	...
	boolean isPropertyChangeListenerRegistered(PropertyChangeListener listener);
	...
	void setOnline() throws SerialPortException;

	void setParameters(int baudRate, int dataBits, int stopBits, int parity);

	void cancelEvents();

	void monitorHandshaking(String portName) throws SerialPortException;
}