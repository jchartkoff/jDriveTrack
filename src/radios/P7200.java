...
public class P7200 implements RadioInterface {
	...
	private void testTimer() {
		...
		testTimer = new Runnable() {@Override
		public void run() {testCycle();}};
	...
	private void rssiClearanceTimer() {
		final ScheduledExecutorService scheduler = Executors.newScheduledThreadPool(1);
		rssiClearanceTimer = new Runnable() {@Override
		public void run() {clearRSSI();}};
	...
	private void busyClearanceTimer() {
		final ScheduledExecutorService scheduler = Executors.newScheduledThreadPool(1);
		busyClearanceTimer = new Runnable() {@Override
		public void run() {clearBusy();}};
	...
	private void berClearanceTimer() {
		final ScheduledExecutorService scheduler = Executors.newScheduledThreadPool(1);
		berClearanceTimer = new Runnable() {@Override
		public void run() {clearBER();}};
	...
	private void errorClearanceTimer() {
		final ScheduledExecutorService scheduler = Executors.newScheduledThreadPool(1);
		errorClearanceTimer = new Runnable() {@Override
		public void run() {clearError();}};
	...
	private void scanTimer() {
		final ScheduledExecutorService scheduler = Executors.newScheduledThreadPool(1);
		scanTimer = new Runnable() {@Override
		public void run() {scanCycle();}};
	...
	private void squelchClearanceTimer() {
		final ScheduledExecutorService scheduler = Executors.newScheduledThreadPool(1);
		squelchClearanceTimer = new Runnable() {@Override
		public void run() {clearSquelch();}};
