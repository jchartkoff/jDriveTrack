...
public class Sinad extends Thread {
	...
	private int avg = 0;
	private ArrayList<ChangeListener> sinadChangedChangeListeners;
	...
	public void addSinadChangedChangeListener (ChangeListener cl) {
		if (sinadChangedChangeListeners == null) {
			sinadChangedChangeListeners = new ArrayList<ChangeListener>();
		}
		sinadChangedChangeListeners.add(cl);
	}

	private void sinadLevelChanged() {
		for (ChangeListener cl : sinadChangedChangeListeners) {
