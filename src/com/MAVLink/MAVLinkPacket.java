...
import com.MAVLink.gps.CRC;
import com.MAVLink.common.*;
import com.MAVLink.gps.*;
...
* 3            System ID           1 - 255     	ID of the SENDING system. Allows to differentiate different MAVs on the 
* 												same network.
* 4            Component ID        0 - 255     	ID of the SENDING component. Allows to differentiate different components 
...
* Please see the MAVLink source code for a documented C-implementation of it. LINK TO CHECKSUM
    ...
    */
    public MAVLinkMessage unpack() {
        switch (msgid) {
            ...
            case msg_gps_date_time.MAVLINK_MSG_ID_GPS_DATE_TIME:
                return  new msg_gps_date_time(this);
                 
            case msg_uav_status.MAVLINK_MSG_ID_UAV_STATUS:
                return  new msg_uav_status(this);
                 
            case msg_status_gps.MAVLINK_MSG_ID_STATUS_GPS:
                return  new msg_status_gps(this);
