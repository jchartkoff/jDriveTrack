...
public class Arrow extends JPanel {
	...
	public Arrow() {
		this(new Point.Double(), new Point.Double(), new Point.Double(), 10, 0, new Dimension(800,600), Color.GREEN);
	}
	
	public Arrow(Dimension mapSize) {
		this(new Point.Double(), new Point.Double(), new Point.Double(), 10, 0, mapSize, Color.GREEN);
	}
	
	public Arrow(Point.Double upperLeftPoint, Point.Double lowerRightPoint, Point.Double point, int arrowSize, 
			int angle, Dimension mapSize, Color color) {
